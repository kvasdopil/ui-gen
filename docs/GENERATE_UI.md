...
- **Icons**: Use SVG icons directly embedded in HTML or use icon fonts/CDN (Font Awesome, Material Icons, Heroicons, etc.)
...
<div class="flex h-full w-full overflow-y-auto">
  <!-- Example with SVG icon - touchable elements need cursor-pointer -->
  <div class="flex h-11 w-11 items-center justify-center cursor-pointer">
  ...
  <div class="h-11 px-4 bg-blue-500 text-white rounded-lg cursor-pointer flex items-center justify-center">
    Button
  </div>
...
- Use SVG icons directly embedded in HTML or reference icon fonts/CDN for all icon needs - choose appropriate icon sets (FontAwesome, Material Design, Heroicons, etc.)
